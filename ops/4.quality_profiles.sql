...
INSERT OR IGNORE INTO "quality_profiles" ("name", "description", "upgrades_allowed", "minimum_custom_format_score", "upgrade_until_score", "upgrade_score_increment") VALUES ('1080p Compact [FR]', '1080p Compact FR cible des encodes Blu-ray et WEB x265 de qualité faible à moyenne,
...
INSERT OR IGNORE INTO "quality_profiles" ("name", "description", "upgrades_allowed", "minimum_custom_format_score", "upgrade_until_score", "upgrade_score_increment") VALUES ('1080p Efficient [FR]', '1080p Efficient FR cible des encodes Blu-ray et WEB x265 de bonne qualité, avec
...
INSERT OR IGNORE INTO "quality_profiles" ("name", "description", "upgrades_allowed", "minimum_custom_format_score", "upgrade_until_score", "upgrade_score_increment") VALUES ('1080p Remux [FR]', '1080p Remux FR utilise les **formats audio** pour prioriser les Blu-ray HD
...
INSERT OR IGNORE INTO "quality_profiles" ("name", "description", "upgrades_allowed", "minimum_custom_format_score", "upgrade_until_score", "upgrade_score_increment") VALUES ('2160p Remux [FR]', '2160p Remux FR utilise les **formats vidéo et audio** pour prioriser les copies
...
Aucune préférence entre x264 et x265, avec un compromis entre Efficient et Quality.', 1, 20000, 1000000, 1);
...
Logique identique à Anime 1080p FR, sans audio français.', 1, 20000, 1000000, 1);
INSERT OR IGNORE INTO "quality_profiles" ("name", "description", "upgrades_allowed", "minimum_custom_format_score", "upgrade_until_score", "upgrade_score_increment") VALUES ('2160p Compact [FR]', '2160p Compact FR cible des encodes Blu-ray x265 de type 4KLight,
avec des fichiers plus légers.
